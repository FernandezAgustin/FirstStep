                ...
                if (movimiento == 1) {
                    ...
                    for (int i = 0; i <= 3; i++) {
                        ...
                        if (elegir < defensa && i != 2) {
                            ...
                            System.out.println("Acertaste! Tus rápidos reflejos permiten moverte y esquivar tremendo golpe!");
                            break;
                        }
                    }
                }
